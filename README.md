...
[--> See it live.](https://superjoshua.github.io/fcc-prod-land-page/)

This was a project required for getting the Responsive Web Design Certificate from freeCodeCamp. It required the fulfillment of these "user stories". This one shows its age by using iframes to display videos.
